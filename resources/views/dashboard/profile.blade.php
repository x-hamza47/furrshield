                ...
                <div class="card-modern mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ asset($user->profile_picture_url) }}" alt="user-avatar" class="d-block rounded"
                            ...
                            <div class="button-wrapper">
                                ...
                                <form action="{{ route('profile.removeAvatar', $user->id) }}" method="POST">
                                    ...
                                    @method('DELETE')
                                    <button type="submit"
                                        class="btn btn-outline-secondary btn-modern account-image-reset mb-2">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('profile.destroy', $user->id) }}" method="POST">
                            ...
                            <div class="form-check mb-3">
                                <input class="form-check-input" type="checkbox" name="confirm" id="accountActivation"
                                    required>
